...
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/thinking-models-research.md
...
```bash
node "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
