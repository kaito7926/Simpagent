...
```bash
INIT=$(node "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/templates/spec.md.
