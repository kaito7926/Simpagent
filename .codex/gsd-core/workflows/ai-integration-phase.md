...
<required_reading>
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/ai-frameworks.md
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/agents/gsd-eval-planner.md for instructions.
