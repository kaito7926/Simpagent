...
INSTALL_JS_GLOBAL="D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
