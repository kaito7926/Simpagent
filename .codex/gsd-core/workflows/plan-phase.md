...
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/ui-brand.md
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/revision-loop.md
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/gate-prompts.md
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/agent-contracts.md
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/gates.md
</required_reading>
...
- Planner is instructed to produce `SKELETON.md` in the phase directory alongside `PLAN.md`. The template lives at `@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/skeleton-template.md`.
...
**If found:**
1. Read template: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/templates/VALIDATION.md`
...
UI_GATE_JS=$(for _c in "$_GSD_RT/gsd-core/bin/lib/ui-safety-gate.cjs" "$_GSD_RT/bin/lib/ui-safety-gate.cjs" "$_GSD_RT/.claude/bin/lib/ui-safety-gate.cjs" "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/lib/ui-safety-gate.cjs" "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/bin/lib/ui-safety-gate.cjs"; do [ -f "$_c" ] && { echo "$_c"; break; }; done)
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/tdd.md to all eligible tasks:
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
...
${MVP_MODE === 'true' ? `
<mvp_mode_active>
**MVP Mode is ENABLED.** Follow vertical-slice planning rules from @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/references/planner-mvp-mode.md. Each plan must deliver a complete vertical slice — thin end-to-end functionality rather than horizontal layers.
</mvp_mode_active>
` : ''}
</planning_context>
