...
```
Agent(
  prompt="Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/templates/VALIDATION.md`
