...
```bash
INIT=$(node "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.codex/gsd-core/bin/gsd-tools.cjs" commit \
