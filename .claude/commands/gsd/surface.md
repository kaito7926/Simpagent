...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/.gsd-surface.json`
(sibling to `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/skills`).
...
`D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/.gsd-surface.json`
Install profile marker: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/.gsd-profile`
Skill dirs: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/skills/gsd-*/`
Engine module: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
