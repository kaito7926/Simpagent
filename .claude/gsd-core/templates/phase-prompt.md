...
<!-- For checkpoint task examples and patterns, see @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
