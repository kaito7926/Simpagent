...
```markdown
Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/agents/gsd-ui-checker.md for instructions.
