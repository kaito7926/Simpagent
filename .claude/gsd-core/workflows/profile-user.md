...
Key references:
- @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/ui-brand.md (display patterns)
- @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/USER-PROFILE.md" "D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/user-profiling.md`
...
Reference: @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/CLAUDE.md
```
