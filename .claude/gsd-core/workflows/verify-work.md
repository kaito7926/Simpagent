...
<template>
@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/workflows/transition.md`.
...
- Follow @D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/workflows/diagnose-issues.md
