...
- **Global scope**: `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/notes/`)
...
2. Glob `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/notes/` — works in any directory
