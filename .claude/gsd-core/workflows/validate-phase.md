...
```
Agent(
  prompt="Read D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/ADMIN/Documents/matmahoc/@DO_AN/Simpagent/.claude/gsd-core/templates/VALIDATION.md`
